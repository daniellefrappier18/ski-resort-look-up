...
const ResortListPanel: React.FC<ResortListPanelProps> = ({
  ...
  return (
    <div
      className={`fixed right-0 top-0 h-full w-full sm:w-80 bg-white border-l border-gray-300 shadow-2xl z-50 transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : 'translate-x-full'}`}
    >
